                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-7 col-lg-10">
                            <div class="s-section-title text-center mb-60">
                                <h2>Privacy Policy for Language Limousine</h2>
                                <h4>Effective Date: 01/01/2025</h4>
                                <p>Language Limousine is committed to safeguarding your privacy and ensuring the protection of your personal information. This Privacy Policy outlines how we collect, use, store, and protect the information you provide when using our services.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="int-services-content">
                            <ul style="list-style-type: bullet;">
                                <li style="margin-bottom: 15px; font-weight: bold;">1. Information We Collect<br>
                                    <span style="font-weight: normal;">We collect personal information when you interact with our services, including but not limited to:
                                        <ul>
                                            <li>• Name</li>
                                ...
                                <li style="margin-bottom: 15px; font-weight: bold;">2. How We Use Your Information<br>
                                    <span style="font-weight: normal;">The information we collect is used for the following purposes:
                                        <ul>
                                            <li>• To provide and improve our services</li>
                                            <li>• To process payments and transactions</li>
                                            <li>• To communicate with you regarding bookings and support</li>
                                            <li>• To send promotional materials (with opt-in consent)</li>
                                        </ul>
                                    </span>
                                </li>

                                <li style="margin-bottom: 15px; font-weight: bold;">3. Data Retention and Deletion<br>
                                    <span style="font-weight: normal;">We retain your personal data only for as long as necessary to fulfill the purposes for which it was collected. Data will not be retained for more than 5 years unless required by law.</span>
                                </li>

                                <li style="margin-bottom: 15px; font-weight: bold;">4. Data Sharing and Disclosure<br>
                                    <span style="font-weight: normal;">We do not share, sell, rent, or trade your personal information with third parties for marketing purposes. We may share personal information with trusted third-party service providers who assist us in operating our business, such as payment processors or IT support. These providers are required to maintain the confidentiality of your data and use it only for the purposes for which it was shared.
We may also disclose personal information if required by law or in response to legal processes, such as a subpoena or court order.
</span>
                                </li>

                                <li style="margin-bottom: 15px; font-weight: bold;">5. Data Security<br>
                                    <span style="font-weight: normal;">We take reasonable precautions to protect your personal information from unauthorized access, alteration, disclosure, or destruction. We use secure encryption protocols for payment transactions and implement appropriate safeguards to maintain the security of your data.</span>
                                </li>

                                <li style="margin-bottom: 15px; font-weight: bold;">6. Your Rights and Choices<br>
                                    <span style="font-weight: normal;">You have the right to access, update, or delete your personal information at any time. If you would like to exercise any of these rights, please contact us at book@languagelimousine.com. You may also request that we stop sending you marketing communications by following the unsubscribe instructions in our emails, if applicable.</span>
                                </li>
                                <li style="margin-bottom: 15px; font-weight: bold;">7.  Cookies and Tracking Technologies<br>
                                    <span style="font-weight: normal;">You have the right to access, update, or delete your personal information at any time. If you would like to exercise any of these rights, please contact us at book@languagelimousine.com. You may also request that we stop sending you marketing communications by following the unsubscribe instructions in our emails, if applicable.</span>
                                </li>
                                <li style="margin-bottom: 15px; font-weight: bold;">8. Third-Party Websites<br>
                                    <span style="font-weight: normal;">Our website may contain links to third-party websites. We are not responsible for the privacy practices of these websites and encourage you to review their privacy policies before providing any personal information.</span>
                                </li>
                                <li style="margin-bottom: 15px; font-weight: bold;">9. Children’s Privacy<br>
                                    <span style="font-weight: normal;">Our services are not intended for individuals under the age of 13, and we do not knowingly collect personal information from children. If we learn that we have collected personal information from a child under 13, we will take steps to delete that information.</span>
                                </li>
                                <li style="margin-bottom: 15px; font-weight: bold;">10. Changes to This Privacy Policy<br>
                                    <span style="font-weight: normal;">We may update this Privacy Policy from time to time. Any changes will be posted on this page, and the updated Privacy Policy will be effective as of the date of posting. We encourage you to review this Privacy Policy periodically.</span>
                                </li>

                                <li style="margin-bottom: 15px; font-weight: bold;">11. Contact Information<br>
                                    <span style="font-weight: normal;">
                                        Language Limousine<br>
                                        Email: book@languagelimousine.com<br>
                                        Phone: 778-773-5466
                                    </span>
                                </li>
                            </ul>
